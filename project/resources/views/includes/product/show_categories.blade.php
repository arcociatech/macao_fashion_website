<div class="col-lg-3 col-md-3 col-12 remove-padding" style="height: 353px !important">
    <a href="{{ route('front.subcat', ['slug1' => 'women', 'slug2' => 'robe']) }}" class="item" style="height: 100% !important">
        ...
        <div class="info" style="margin-top: -36px!important">
            <h2 class="name" style="height:41px;">{{ 'Robe' }}</h2>
        </div>
    </a>
</div>
<div class="col-lg-3 col-md-3 col-12 remove-padding">
    <a href="{{ route('front.childcat', ['slug1' => 'women', 'slug2' => 'bas', 'slug3' => 'denim-jeans']) }}" class="item" style="height: 100% !important">
        ...
        <div class="info" style="margin-top: -36px!important">
            <h2 class="name" style="height:41px;">{{ 'Jeans' }}</h2>
        </div>
    </a>
</div>
<!--<div class="col-lg-4 col-md-3 col-6 remove-padding">-->

<!--    <a href="{{ route('front.category', ['category' => 'chaussure']) }}" class="item" style="height: 100% !important">-->
<!--        <div class="item-img">-->
<!--            <img class="img-fluid img-thumbnail" src="{{ asset('assets/category/chaussure.jpeg') }}" alt="">-->
<!--        </div>-->
<!--        <div class="info" style="margin-top: -36px!important">-->
<!--            <h2 class="name" style="height:41px;">{{ 'Chaussure' }}</h2>-->
<!--        </div>-->
<!--    </a>-->
<!--</div>-->
<div class="col-lg-3 col-md-3 col-12 remove-padding">
    <a href="{{ route('front.subcat', ['slug1' => 'women', 'slug2' => 'top']) }}" class="item" style="height: 100% !important">
        ...
        <div class="info" style="margin-top: -36px!important">
            <h2 class="name" style="height:41px;">{{ 'Top' }}</h2>
        </div>
    </a>
</div>
<div class="col-lg-3 col-md-3 col-12 remove-padding">
    <a href="{{ route('front.childcat', ['slug1' => 'women', 'slug2' => 'veste', 'slug3' => 'blazer']) }}" class="item" style="height: 100% !important">
        ...
        <div class="info" style="margin-top: -36px!important">
            <h2 class="name" style="height:41px;">{{ 'Blazer' }}</h2>
        </div>
    </a>
</div>
<!--<div class="col-lg-4 col-md-3 col-6 remove-padding">-->
<!--    <a href="{{ route('front.subcat', ['slug1' => 'chaussure', 'slug2' => 'ceinture']) }}" class="item" style="height: 100% !important">-->
<!--        <div class="item-img">-->
<!--            <img class="img-fluid img-thumbnail" src="{{ asset('assets/category/robe.jpg') }}" alt="">-->
<!--        </div>-->
<!--        <div class="info" style="margin-top: -36px!important">-->
<!--            <h2 class="name" style="height:41px;">{{ 'Cérémonie' }}</h2>-->
<!--        </div>-->
<!--    </a>-->
<!--</div>-->
