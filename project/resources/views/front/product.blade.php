                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-12">
                            ...
                            <div class="xzoom-container">
                                <img class="xzoom5 img-fluid img-thumbnail" id="xzoom-magnific" height="600px"
                                    width="100%"
                                    src="{{ filter_var($productt->photo, FILTER_VALIDATE_URL) ? $productt->photo : $productt->photo }}"
                                    xoriginal="{{ filter_var($productt->photo, FILTER_VALIDATE_URL) ? $productt->photo : $productt->photo }}" />
                                        ...
                                        @if (!empty($productt->color_image))
                                            ...
                                            @foreach ($productt->color_image as $key => $data1)
                                                ...
                                                <a href="{{ asset($productt->color_image[$key]) }}">
                                                    <img class="xzoom-gallery5" width="80"
                                                        src="{{ asset($productt->color_image[$key]) }}"
                                                        title="Product Image">
                                                </a>
                                                @php
                                                    $is_first = false;
                        ...
                        <div class="col-lg-8">
                            <div class="right-area">
                                <div class="product-info">
                                            ...
                                            <ul class="color-list">
                                                ...
                                                @foreach ($productt->color_image as $key => $data1)
                                                    ...
                                                    <li class="{{ $is_first ? 'active' : '' }} text-center color-select">
                                                        ...
                                                        @endphp
                                                        <img class="xzoom-gallery5 box" data-color="{{ $color ?? '' }}"
                                                            src="{{ asset($productt->color_image[$key]) }}"
                                                            alt="{{ $color }} image "width="60px" height="60px"
                                                            style="border-radius: 30px; width: 60px; height:60px; z-index: 1;">
                                                        <br>
                                                        {{ $color }}
                                                    </li>
                                                    @php
                                    ...
                                    <p @if (!$productt->details) class="hidden" @endif>
                                        <b>
                                            Description
                                        </b>
                                    </p>
