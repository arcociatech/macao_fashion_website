...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('admin-prod-index') }}">{{ __('Hot Products') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <div class="top-area">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <a href="javascript:;" onclick="window.location.reload(true)" class="upload-done" data-dismiss="modal"> <i
    ...
    <div class="modal fade" id="setMainImage" tabindex="-1" role="dialog" aria-labelledby="setMainImage"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                            ...
                            <div class="col-sm-6 text-right">
                                <div class="upload-img-btn">
                                    <form method="POST" enctype="multipart/form-data" id="form-setMainImage">
                                        ...
                                        <input type="file" name="setMainImage" class="hidden" id="uploadsetMainImage"
                                            accept="image/*" multiple>
                                        <label for="image-upload" id="prod_setMainImage"><i
                                                class="icofont-upload-alt"></i>{{ __('Upload File') }}</label>
                                    </form>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="setDescription" tabindex="-1" role="dialog" aria-labelledby="setDescription"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
...
@section('scripts')
    ...
    <script type="text/javascript">
        var table = $('#geniustable').DataTable({
            ...
            serverSide: true,
            "pageLength": 100,
            ajax: '{{ route('admin-hot-prod-datatables') }}',
            columns: [{
                    data: 'name',
                    name: 'name'
                },
        ...
        function hotProduct(e, id) {
            ...
            $.ajax({
                url: '{{ url('admin/hot_product_status') }}/' + id,
                method: 'post',
                data: {
                    is_hot: is_hot,
                },
                    ...
                    if (data[0] == 0) {
                        ...
                        for (var k in arr) {
                            $('.selected-image .row').append('<div class="col-sm-6">' +
                                ...
                                // '<input type="hidden" value="'+arr[k]['id']+'">'+
                                // '</span>'+
                                '<a href="' + '{{ asset('assets/images/products') . '/' }}' + arr[
                                    k][
                                    'photo'
                                ] + '" target="_blank">' +
                                '<img src="' + '{{ asset('assets/images/thumbnails') . '/' }}' +
                                arr[
                                    k]['photo'] + '" alt="gallery image">' +
                                '</a>' +
                                '</div>' +
