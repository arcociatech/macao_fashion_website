                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <select id="subcat" name="subcategory_id">
                                                ...
                                                <option data-href="{{ route('admin-childcat-load',$sub->id) }}"
                                                    value="{{$sub->id}}"
                                                    {{$sub->id == $data->subcategory_id ? "selected":""}}>{{$sub->name}}
                                                </option>
                                                @endforeach
                                                @endif
                                                    ...
                                                    <div class="col-lg-5">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox"
                                                                ...
                                                                value="{{$option->name}}"
                                                                class="custom-control-input attr-checkbox" @if(is_array($selectedAttrs) &&
                                                    ...
                                                    <div class="size-area">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 col-sm-6">
                                                                ...
                                                                </label> <input type="number" name="size_qty[]"
                                                                    class="input-field" placeholder="Size Qty" min="1"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 col-sm-6">
                                                                ...
                                                                <input type="number" name="size_qty[]"
                                                                    class="input-field" placeholder="Size Qty" value="1"
                                                                    min="1">
                                                            </div>
                                                            <div class="col-md-4 col-sm-6">
                                                                <label>
                                                ...
                                                <div class="select-input-color" id="color-section">
                                                    ...
                                                    <div class="color-area">
                                                        <span class="remove color-remove"><i
                                                                class="fas fa-times"></i></span>
                                                        <input type="text" name="color[]" placeholder="Enter color name" value="{{ $data->color[$key] }}" class="form-control" />
                                                        ...
                                                        <div class="input-group mb-3 colorpicker-component cp">
                                                            <div class="custom-file">
                                                                ...
                                                                name="color_image[]" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="select-input-color" id="color-section">
                                                    <div class="color-area">
                                                        ...
                                                        {{-- Color Image Start --}}
                                                        <div class="input-group mb-3 cp">
                                                            <div class="input-group-prepend cp">
                                                                <span class="input-group-text" id="inputGroupFileAddon01">Upload</span>
                                                            </div>
                                                            <div class="custom-file">
                                                                <input  name="color_image[]" type="file" class="custom-file-input cp" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
                                                                <label class="custom-file-label" for="inputGroupFile01">Choose file</label>
                                                            </div>
                                                        </div>
                                                        <hr>
